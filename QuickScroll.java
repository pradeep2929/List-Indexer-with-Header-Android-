...
import com.wafer.MainApplication;
import com.wafer.R;

import io.realm.RealmResults;

import static com.wafer.constants.AppConstants.ALPHABET_INDEXER_KEYS;

public class QuickScroll extends View {

    // IDs
    protected static final int ID_PIN = R.id.quick_scroll_pin;
    protected static final int ID_PIN_TEXT = R.id.quick_scroll_pin_text;
    ...
    // base colors
    public static final int GREY_DARK = Color.parseColor("#9437FF");
    public static final int GREY_LIGHT = Color.parseColor("#9437FF");
    public static final int GREY_SCROLLBAR = Color.parseColor("#9437FF");
    public static final int BLUE_LIGHT = Color.parseColor("#9437FF");
    public static final int BLUE_LIGHT_SEMITRANSPARENT = Color.parseColor("#9437FF");
    ...
    private AlphabetIndexerEx mIndexer;
     ...
     */
    public void init(final int type, final ListView list, final Scrollable scrollable, final TextView mTitleText,
                     final int style, final RealmResults<Contact> contactList) {
        typeface = MainApplication.getInstance().getTypeFaceTrebuchetMS();
        this.mTitleText = mTitleText;
        if (isInitialized) return;

        this.mIndexer = new AlphabetIndexerEx(contactList, ALPHABET_INDEXER_KEYS);
        this.type = type;
        listView = list;
        ...
        scrollIndicatorTextView.setTypeface(typeface,Typeface.BOLD);
                    ...
                    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                        ...
                        try {
                            ...
                            if (firstVisibleItem != lastFirstVisibleItem) {
                                ...
                                String key =
                                        (sectionIndex == (ALPHABET_INDEXER_KEYS.length() - 1)) ? "Country code missing" :
                                                String.valueOf(ALPHABET_INDEXER_KEYS.charAt(sectionIndex));

                                mTitleText.setText(key);
    ...
    public AlphabetIndexerEx getIndexer() {
        return mIndexer;
    }
     ...
     */
    public void setPopupColor(final int backgroundcolor, final int bordercolor, final int borderwidthDPI,
                              final int textcolor, float cornerradiusDPI) {
    ...
    protected RelativeLayout createPin() {
        ...
        pin.setId(ID_PIN);
        final RelativeLayout.LayoutParams pinParams = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
        ...
        final RelativeLayout.LayoutParams indicatorParams = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
                LayoutParams.WRAP_CONTENT);
